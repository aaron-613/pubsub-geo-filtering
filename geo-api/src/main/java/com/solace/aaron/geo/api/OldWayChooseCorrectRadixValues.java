 ...
 */
public class OldWayChooseCorrectRadixValues {
...
//            min = -2000;
//            max = 50000;
//            finest = 100;  // 100 feet increments

            // some random metric between [-50,200] with integer precision
//            radix = 4;
//            min = -50;
//            max = 200;
//            finest = 1;

            // heading in radians, represented by a binary presentation
//            radix = 2;
//            min = 0;
//            max = 2*Math.PI;
//            finest = Math.PI/8;

            // outdoor temperature in Celsius, in base7 (?), with 1/2 degree increments
//            radix = 7;
