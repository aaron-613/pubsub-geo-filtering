...
*/		
		...
		public String toString() {
			return String.format("radix=%d, scale=%d, padding=%d, paddingForNegs=%b",radix,scale,padding,paddingForNegs);
		}
		
		public String debugConvert(double val, int factor) {
			return String.format("%s,  val=%f, factor=%d ==> %s", toString(), val, factor, convert(val,factor));
		}
	}
